...
const Similar = (arg = '') => {
    ...
    const preparePage = () => {
            ...
            for (let i = Number(argList[2]) - 9; i < articles.length; i++) {
                    ...
                    <div class="gameInfos">
                        ...
                        <div class="more-about-game collapse">
                            ...
                            <div class="more-element">
                                <a href="#similar/game-series$${articles[i].slug}$9">Show more like this</a>
                            </div>
                            <div class="more-element">
        ...
        fetchList(`https://api.rawg.io/api/games/${argList[1]}/${argList[0]}?page_size=${argList[2]}${ordering}&key=${API_KEY}`);
    };
